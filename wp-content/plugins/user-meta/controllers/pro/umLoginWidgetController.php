...
/**
 * Login widget
 * class name umLoginWidget differ from file name umLoginWidget Controller to prevent creating instance while controller are loaded
 */
...
class umLoginWidget extends WP_Widget {
    ...
    public function __construct() {  
        ...
        parent::__construct(
        	...
        	array( 'description' => __( 'Login Widget', $userMeta->name ) ) // Args
        );         
