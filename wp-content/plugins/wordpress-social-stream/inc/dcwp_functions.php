...
function dcwss_networks($a)
{
	...
	$defaults['facebook'] = Array('id' => '', 'intro' => 'Posted', 'comments' => '3', 'image_width' => '6', 'out' => 'intro,title,text,user,share', 'text' => 'contentSnippet');
...
function dcwss_custom_css()
{
	...
	if($options['fixed'] == 'true'){
		...
		$out .= '.dcwss .stream li {width: ' . $fw . ' margin: ' . $mt . $mr . $mb . $ml . '}';
	}
