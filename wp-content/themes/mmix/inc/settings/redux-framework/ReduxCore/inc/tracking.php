...
if ( !class_exists( 'Redux_Tracking' ) ) {
	...
	class Redux_Tracking {
        ...
        function newsletter_request() {
            ...
            $content .= '<p><strong>'.__( 'Getting Started', 'redux-framework' ).'</strong><br>'.sprintf( __( 'This panel demonstrates the many features of Redux.  Before digging in, we suggest you get up to speed by reviewing %1$s.', 'redux-framework' ), '<a href="https://github.com/ReduxFramework/redux-framework/wiki/Getting-Started" target="_blank">'.__( 'our documentation', 'redux-framework' ).'</a>' );
            $content .= '<p><strong>'.__( 'Redux Extensions', 'redux-framework' ).'</strong><br>'.sprintf( __( 'Did you know Redux has extensions, which enhances its features?  Visit our %1$s to learn more!', 'redux-framework' ), '<a href="http://reduxframework.com/extensions/" target="_blank">'.__( 'extensions directory', 'redux-framework' ).'</a>' );
            $content .= '<p><strong>'.__( 'Like Redux?', 'redux-framework' ).'</strong><br>'.sprintf( __( 'If so, please %1$s and consider making a %2$s to keep development of Redux moving forward.', 'redux-framework' ), '<a target="_blank" href="http://wordpress.org/extend/plugins/redux-framework/">'.__( 'leave us a favorable review on WordPress.org', 'redux-framework' ).'</a>', '<a href="https://www.paypal.com/cgi-bin/webscr?cmd=settings-xclick&hosted_button_id=N5AD7TSH8YA5U" target="_blank">'.__( 'donation', 'redux-framework' ).'</a>' );
